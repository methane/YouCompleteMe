...
function! youcompleteme#Enable()
  ...
  Python from ycm import utils
  Python utils.AddThirdPartyFoldersToSysPath()
  Python from ycm import base
  Python base.LoadJsonDefaultsIntoVim()
  Python from ycm import vimsupport
  ...
  Python from ycm.youcompleteme import YouCompleteMe
  Python ycm_state = YouCompleteMe( user_options_store.GetAll() )
...
function! s:OnBufferVisit()
  ...
  Python ycm_state.OnBufferVisit()
...
function! s:OnBufferUnload( deleted_buffer_file )
  ...
  Python ycm_state.OnBufferUnload( vim.eval( 'a:deleted_buffer_file' ) )
endfunction
...
function! s:OnInsertLeave()
  ...
  let s:omnifunc_mode = 0
  call s:OnFileReadyToParse()
  Python ycm_state.OnInsertLeave()
  if g:ycm_autoclose_preview_window_after_completion ||
...
function! s:RestartServer()
  Python ycm_state.RestartServer()
endfunction
...
function! s:ShowDetailedDiagnostic()
  Python ycm_state.ShowDetailedDiagnostic()
endfunction
